...
venv\Scripts\python -m PyInstaller --clean --noconsole --onedir --name="PotentialPlanner" --distpath "%BUILD_DIR%\dist" --workpath "%BUILD_DIR%\build" --specpath "%BUILD_DIR%" --paths "src" "run.py"
